...
class LongCastApp {
    constructor() {
        ...
        this.translations = {
            ...
            es: {
                ...
                'session.sessionData': 'Datos de la Sesión',
                'session.startDate': 'Fecha de Inicio de Sesión *',
                'session.sessionType': 'Tipo de Sesión *',
                'session.typeField': '📍 Campo (metros)',
                'session.typeSea': '🌊 Mar (vueltas del carrete)',
                'session.location': 'Ubicación *',
                'session.locationPlaceholder': 'ej. Campo de competición, Playa...',
                ...
                'session.leadWeight': 'Peso del Plomo *',
                'session.leadWeightPlaceholder': 'ej. Ogiva 150g, Guardián 175g',
                'session.technique': 'Técnica de Lanzamiento *',
                'session.techniquePlaceholder': 'ej. Overhead, Pendulum, Ground Cast',
                'session.equipment': 'Equipamiento',
                'session.rodModel': 'Modelo/Marca de Caña',
                'session.rodModelPlaceholder': 'ej. Shimano Nexave, Zziplex',
                'session.rodLength': 'Longitud de la Caña (metros)',
                'session.rodLengthPlaceholder': 'ej. 4.2',
                'session.rodCastingWeight': 'Peso de Lanzamiento de la Caña (gr)',
                ...
                'session.metersPerTurnPlaceholder': 'ej. 0.82',
                'session.autoFilled': 'Autocompletado según el carrete',
                'session.initialWeather': 'Condiciones Meteorológicas Iniciales',
                'session.wind': 'Viento',
                'session.windPlaceholder': 'ej. Calmo, Brisa 10 km/h',
                'session.windDirection': 'Dirección del Viento',
                'session.windDirectionPlaceholder': 'ej. A favor, En contra',
                'session.temperature': 'Temperatura (°C)',
                'session.temperaturePlaceholder': 'ej. 18.5',
                'session.humidity': 'Humedad (%)',
                'session.humidityPlaceholder': 'ej. 65',
                'session.notes': 'Notas de la Sesión',
                'session.notesPlaceholder': 'Anotaciones generales...',
                'session.startSession': 'Iniciar Sesión de Entrenamiento',
                'session.sessionInProgress': '📍 Sesión en Curso',
                'session.started': 'Iniciada:',
                'session.casts': 'Lanzamientos:',
                'session.gpsMeasurement': '📍 Medición de Distancia GPS',
                'session.gpsMeasurementDesc': 'Mide la distancia caminando desde el punto de lanzamiento hasta el plomo',
                'session.gpsStart': 'INICIAR Medición GPS',
                'session.gpsStop': 'DETENER y Guardar Lanzamiento',
                'session.manualEntry': '✍️ Entrada Manual de Distancia',
                'session.distance': 'Distancia (metros) *',
                'session.distancePlaceholder': 'ej. 125.5',
                'session.calculatedDistance': 'Distancia calculada:',
                'session.addManualCast': 'Añadir Lanzamiento Manual',
                'session.castNotes': 'Notas (opcional)',
                'session.castNotesPlaceholder': 'Sensaciones sobre este lanzamiento...',
                'session.confirmWeather': 'Confirmar Condiciones Meteorológicas',
                'session.confirmWeatherDesc': '¿Han cambiado las condiciones? Actualiza los datos a continuación',
                'session.sessionCasts': 'Lanzamientos de la Sesión',
                'session.noCastsYet': 'Aún no hay lanzamientos registrados en esta sesión',
                'session.endSession': 'Finalizar Sesión de Entrenamiento',
                ...
                'session.directionSet': 'Dirección establecida:',
                'session.directionNotSet': 'Dirección aún no establecida - Haz clic en el botón de arriba',
                'session.openFieldDirectionMap': '🗺️ Establecer Dirección del Campo en el Mapa',

                // Map
                'map.title': '🗺️ Mapa de Lanzamientos GPS',
                'map.setFieldDirection': '🗺️ Establecer Dirección del Campo',
                'map.closeMap': 'Cerrar Mapa',
                'map.confirm': '✓ Confirmar',
                'map.castingPoint': 'Punto de Lanzamiento',
                'map.leadFall': 'Caída del Plomo',
                'map.trajectory': 'Trayectoria',
                ...
                'history.last3months': 'Últimos 3 meses',
                ...
                'history.dateNewest': 'Fecha (más reciente)',
                'history.dateOldest': 'Fecha (más antigua)',
                'history.dateDesc': 'Fecha (más reciente)',
                'history.dateAsc': 'Fecha (menos reciente)',
                'history.noSessions': 'No se encontraron sesiones',
                'history.previous': 'Anterior',
                'history.next': 'Siguiente',
                'history.page': 'Página',
                'history.of': 'de',
                'history.backToSessions': 'Volver a Sesiones',
                'history.sessionDetail': 'Detalle de Sesión',
                'history.sessionCasts': 'Lanzamientos de la Sesión',
                ...
                'partners.coaches': 'Maestros de Lanzamiento y Pesca',
                'partners.website': 'Sitio Web',
                'partners.call': 'Llamar',
                'partners.email': 'Email',
                'partners.becomePartner': 'Conviértete en Socio',
                'partners.becomePartnerDesc': '¿Eres una empresa, asociación o instructor? ¡Únete a nuestra red oficial de socios!',
                'partners.contactUs': 'Contáctanos',
                ...
                'settings.saveUnits': 'Guardar Unidades de Medida',
                'settings.backup': '☁️ Copia de Seguridad y Nube',
                'settings.backupDesc': 'Gestiona tus datos y copia de seguridad en la nube',
                'settings.exportData': 'Exportar Datos (JSON)',
                'settings.importData': 'Importar Datos (JSON)',
                ...
                'settings.cloudSyncDesc': 'Función de sincronización en la nube disponible en la versión premium',
                ...
                'settings.installAppDesc': 'Instala Longcasting Pro en tu dispositivo para una experiencia óptima',
                ...
                'profile.age': 'Edad *',
                'profile.agePlaceholder': 'ej. 35',
                'profile.gender': 'Género *',
                'profile.male': 'Masculino',
                'profile.female': 'Femenino',
                'profile.other': 'Otro',
                'profile.physicalData': 'Datos Físicos',
                'profile.height': 'Altura (cm) *',
                'profile.heightPlaceholder': 'ej. 175',
                'profile.weight': 'Peso (kg) *',
                'profile.weightPlaceholder': 'ej. 75.5',
                'profile.bmi': 'IMC (calculado automáticamente)',
                ...
                'profile.distanceGoal': 'Objetivo de Distancia (m)',
                'profile.distanceGoalPlaceholder': 'ej. 150',
                'profile.trainingField': 'Campo de Entrenamiento',
                'profile.trainingFieldPlaceholder': 'ej. Campo de Competición XYZ',
                ...
                'common.continueWithout': 'Continuar Sin',
                ...
                'gps.retryQuestion': '¿Quieres reintentar la adquisición del GPS o iniciar la sesión sin punto de pivote?',
                ...
                'validation.invalidNumber': 'Introduce un número válido'
            },
            fr: {
                // Navigation
                ...
                'session.sessionData': 'Données de la Session',
                'session.startDate': 'Date de Début de Session *',
                'session.sessionType': 'Type de Session *',
                'session.typeField': '📍 Terrain (mètres)',
                'session.typeSea': '🌊 Mer (tours de moulinet)',
                'session.location': 'Lieu *',
                'session.locationPlaceholder': 'ex. Terrain de compétition, Plage...',
                'session.castingDirection': 'Direction du Terrain (degrés) *',
                'session.castingDirectionPlaceholder': '0-359° (0=Nord, 90=Est)',
                'session.castingDirectionHelper': '0°=Nord, 90°=Est, 180°=Sud, 270°=Ouest',
                'session.leadWeight': 'Poids du Plomb *',
                'session.leadWeightPlaceholder': 'ex. Ogive 150g, Gardien 175g',
                'session.technique': 'Technique de Lancer *',
                'session.techniquePlaceholder': 'ex. Overhead, Pendulum, Ground Cast',
                'session.equipment': 'Équipement',
                'session.rodModel': 'Modèle/Marque de Canne',
                'session.rodModelPlaceholder': 'ex. Shimano Nexave, Zziplex',
                'session.rodLength': 'Longueur de Canne (mètres)',
                'session.rodLengthPlaceholder': 'ex. 4.2',
                'session.rodCastingWeight': 'Puissance de Lancer de la Canne (gr)',
                ...
                'session.metersPerTurnPlaceholder': 'ex. 0.82',
                'session.autoFilled': 'Rempli automatiquement selon le moulinet',
                'session.initialWeather': 'Conditions Météo Initiales',
                'session.wind': 'Vent',
                'session.windPlaceholder': 'ex. Calme, Brise 10 km/h',
                'session.windDirection': 'Direction du Vent',
                'session.windDirectionPlaceholder': 'ex. Favorable, Contraire',
                'session.temperature': 'Température (°C)',
                'session.temperaturePlaceholder': 'ex. 18.5',
                'session.humidity': 'Humidité (%)',
                'session.humidityPlaceholder': 'ex. 65',
                'session.notes': 'Notes de Session',
                'session.notesPlaceholder': 'Annotations générales...',
                'session.startSession': 'Démarrer Session d\'Entraînement',
                'session.sessionInProgress': '📍 Session en Cours',
                'session.started': 'Démarrée:',
                'session.casts': 'Lancers:',
                'session.gpsMeasurement': '📍 Mesure de Distance GPS',
                'session.gpsMeasurementDesc': 'Mesurez la distance en marchant du point de lancer au plomb',
                'session.gpsStart': 'DÉMARRER Mesure GPS',
                'session.gpsStop': 'ARRÊTER et Enregistrer Lancer',
                'session.manualEntry': '✍️ Saisie Manuelle de Distance',
                'session.distance': 'Distance (mètres) *',
                'session.distancePlaceholder': 'ex. 125.5',
                'session.calculatedDistance': 'Distance calculée:',
                'session.addManualCast': 'Ajouter Lancer Manuel',
                'session.castNotes': 'Notes (optionnel)',
                'session.castNotesPlaceholder': 'Sensations sur ce lancer...',
                'session.confirmWeather': 'Confirmer Conditions Météo',
                'session.confirmWeatherDesc': 'Les conditions ont-elles changé? Mettez à jour les données ci-dessous',
                'session.sessionCasts': 'Lancers de la Session',
                'session.noCastsYet': 'Aucun lancer enregistré dans cette session',
                'session.endSession': 'Terminer Session d\'Entraînement',
                ...
                'session.directionSet': 'Direction définie:',
                'session.directionNotSet': 'Direction pas encore définie - Cliquez sur le bouton ci-dessus',
                'session.openFieldDirectionMap': '🗺️ Définir Direction du Terrain sur la Carte',

                // Map
                'map.title': '🗺️ Carte des Lancers GPS',
                'map.setFieldDirection': '🗺️ Définir Direction du Terrain',
                'map.closeMap': 'Fermer la Carte',
                'map.confirm': '✓ Confirmer',
                'map.castingPoint': 'Point de Lancer',
                'map.leadFall': 'Chute du Plomb',
                'map.trajectory': 'Trajectoire',
                ...
                'history.all': 'Tous',
                'history.last7days': 'Derniers 7 jours',
                'history.last30days': 'Derniers 30 jours',
                'history.last3months': 'Derniers 3 mois',
                'history.lastYear': 'Dernière année',
                'history.week': 'Dernière semaine',
                'history.month': 'Dernier mois',
                'history.months3': 'Derniers 3 mois',
                'history.sortBy': 'Trier par',
                'history.dateNewest': 'Date (plus récent)',
                'history.dateOldest': 'Date (plus ancien)',
                'history.dateDesc': 'Date (plus récent)',
                'history.dateAsc': 'Date (moins récent)',
                'history.noSessions': 'Aucune session trouvée',
                'history.previous': 'Précédent',
                'history.next': 'Suivant',
                'history.page': 'Page',
                'history.of': 'de',
                'history.backToSessions': 'Retour aux Sessions',
                'history.sessionDetail': 'Détail de Session',
                'history.sessionCasts': 'Lancers de la Session',
                ...
                'partners.associations': 'Associations',
                'partners.coaches': 'Maîtres de Lancer et Pêche',
                'partners.website': 'Site Web',
                'partners.call': 'Appeler',
                'partners.email': 'Email',
                'partners.becomePartner': 'Devenir Partenaire',
                'partners.becomePartnerDesc': 'Êtes-vous une entreprise, une association ou un instructeur? Rejoignez notre réseau de partenaires officiels!',
                ...
                'settings.saveUnits': 'Enregistrer Unités de Mesure',
                'settings.backup': '☁️ Sauvegarde & Cloud',
                'settings.backupDesc': 'Gérez vos données et sauvegarde cloud',
                'settings.exportData': 'Exporter Données (JSON)',
                'settings.importData': 'Importer Données (JSON)',
                ...
                'settings.cloudSyncDesc': 'Fonction de synchronisation cloud disponible dans la version premium',
                'settings.cloudPremium': 'Fonction de synchronisation cloud disponible dans la version premium',
                'settings.installApp': '📱 Installer Application',
                'settings.installAppDesc': 'Installez Longcasting Pro sur votre appareil pour une expérience optimale',
                ...
                'profile.age': 'Âge *',
                'profile.agePlaceholder': 'ex. 35',
                'profile.gender': 'Genre *',
                'profile.male': 'Masculin',
                'profile.female': 'Féminin',
                'profile.other': 'Autre',
                'profile.physicalData': 'Données Physiques',
                'profile.height': 'Taille (cm) *',
                'profile.heightPlaceholder': 'ex. 175',
                'profile.weight': 'Poids (kg) *',
                'profile.weightPlaceholder': 'ex. 75.5',
                'profile.bmi': 'IMC (calculé automatiquement)',
                ...
                'profile.distanceGoal': 'Objectif de Distance (m)',
                'profile.distanceGoalPlaceholder': 'ex. 150',
                'profile.trainingField': 'Terrain d\'Entraînement',
                'profile.trainingFieldPlaceholder': 'ex. Terrain de Compétition XYZ',
                'profile.saveProfile': 'Enregistrer Profil',
                'profile.dataManagement': 'Gestion des Données',
                'profile.exportData': 'Exporter Données',
                'profile.importData': 'Importer Données',
                ...
                'common.continueWithout': 'Continuer Sans',
                ...
                'gps.retryQuestion': 'Voulez-vous réessayer l\'acquisition GPS ou démarrer la session sans point de pivot?',
                'gps.retryButton': 'Réessayer GPS',
                'gps.continueButton': 'Continuer Sans GPS',
                'gps.attempt': 'Tentative',
                'gps.of': 'de',
                'validation.required': 'Ce champ est obligatoire',
                'validation.fillRequired': 'Remplissez tous les champs obligatoires (*) avant de continuer',
                'validation.invalidNumber': 'Entrez un nombre valide'
            }
        };
    ...
    deleteCastByIndex(sessionId, castIndex) {
        if (!confirm('Sei sicuro di voler eliminare questo lancio?')) {
            return;
        }
        ...
        if (castIndex < 0 || castIndex >= session.lanci.length) {
            this.showToast('Lancio non trovato', 'error');
            return;
        }

        // Remove the cast from the session by index
        session.lanci.splice(castIndex, 1);
    ...
    showSessionDetail(sessionId) {
        ...
        if (session.lanci && session.lanci.length > 0) {
            ...
            const totalLanci = session.lanci.length;
            castsContainer.innerHTML = reversedLanci.map((lancio, index) => {
                // Calculate original index (before reverse)
                const originalIndex = totalLanci - 1 - index;
                return this.createCastDetailHTML(lancio, index + 1, session.id, originalIndex);
            }).join('');
        } else {
    ...
    createCastDetailHTML(lancio, numero, sessionId, castIndex) {
        // Support both 'orario' (new) and 'data' (old) fields
        const timestamp = lancio.orario || lancio.data;
        const data = timestamp ? new Date(timestamp) : null;
        const formattedTime = data ? data.toLocaleTimeString('it-IT', {
            hour: '2-digit',
            minute: '2-digit'
        }) : '--:--';

        // Use id if available, otherwise use index
        const castId = lancio.id !== undefined ? lancio.id : castIndex;

        return `
            <div class="cast-detail-item" data-cast-index="${castIndex}">
                <div class="cast-detail-header">
                    ...
                    <button class="btn-delete-cast" onclick="app.deleteCastByIndex(${sessionId}, ${castIndex})" title="Elimina lancio">
