...
2. L'app è completamente client-side, non richiede server
...
- **HTML5**: struttura semantica e canvas per grafici
- **CSS3**: design moderno con variabili CSS, gradients e animazioni
- **JavaScript Vanilla**: logica dell'applicazione senza dipendenze esterne
